...
def test_text_formatting():
  ...
  text = r'''This is a simple string.'''
  assert text == format_text( text )

  text = r'''This is a simple string.'''
  assert text == format_text( text, **context )

  text = r'''A = <A>.'''
  assert r"A = 1 meter." == format_text( text, **context )

  text = r'''A = <A>. B = <B:.2f>.'''
  assert r"A = 1 meter. B = 2.00 meter / second." == format_text( text, **context )

  text = r'''A = <A>. B = <B:.2f>. <missing>'''
  assert r"A = 1 meter. B = 2.00 meter / second. <missing>" == format_text( text, **context )
